                        ...
                        <div class="our-stores-item__content">
                            ...
                            <div class="our-stores-item__actions">
                                <?php if ( ! empty( $store['view_details_link'] ) ) : ?>
                                    <a href="<?php echo esc_url( $store['view_details_link'] ); ?>" class="our-stores-item__btn our-stores-item__btn--details">
                                        <?php esc_html_e( 'View Details', 'ahadul' ); ?>
                                    </a>
                                <?php endif; ?>

                                <?php if ( ! empty( $store['book_now_link'] ) ) : ?>
                                    <a href="<?php echo esc_url( $store['book_now_link'] ); ?>" class="our-stores-item__btn our-stores-item__btn--book">
